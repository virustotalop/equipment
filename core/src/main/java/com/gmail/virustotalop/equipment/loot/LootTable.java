...
public class LootTable<T extends Loot> {

    private final Map<Integer, Map.Entry<T, Integer>> table;
    private final int scale;

    public LootTable(@NotNull Map<T, Integer> table) {
        this(table, 100);
    }

    public LootTable(@NotNull Map<T, Integer> table, int scale) {
